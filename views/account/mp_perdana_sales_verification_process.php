...
if ($submission) {
    ...
    $berhadNetAmount = (float) $submission['berhad_sales'];
    ...
    $berhadNetAmount = (float) $submission['berhad_sales'] - $totalMpBerhadExpenses;
    ...
    <style>
        * {
        ...
        .loading-progress-bar {
            height: 100%;
            background: linear-gradient(90deg, #c2410c 0%, #f97316 50%, #c2410c 100%);
        ...
        <?php elseif ($submission) : ?>
            ...
            <div class="card">
                ...
                <div class="grid">
                    ...
                    <div class="stat">
                        <div class="label">Berhad Net Amount</div>
