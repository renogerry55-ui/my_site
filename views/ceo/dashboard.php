...
// Require authentication and CEO role
requireRole('ceo');
...
<head>
    ...
    <title>CEO Dashboard - <?php echo htmlspecialchars(APP_NAME); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <h2 style="color: #333; margin-bottom: 20px;">Executive Dashboard</h2>
        <div class="quick-links">
            ...
            <a href="#" class="link-card">
                ...
                <p>High-level company performance metrics</p>
            </a>

            <a href="#" class="link-card">
                <h3>Strategic Planning</h3>
                <p>Access strategic planning tools</p>
            </a>
        </div>
    </div>
</body>
