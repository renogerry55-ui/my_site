...
function buildNormalizedRows(array $rows)
{
    ...
    foreach ($rows as $row) {
        ...
        $normalizedRows[] = [
            ...
            'name' => sanitizeStringValue($cells[1], 255),
            'level' => sanitizeStringValue($cells[2], 100),
            'deposit_count' => sanitizeStringValue($cells[3], 100),
            'total_deposit' => sanitizeStringValue($cells[4], 100),
            'withdraw_count' => sanitizeStringValue($cells[5], 100),
            'total_withdraw' => sanitizeStringValue($cells[6], 100),
            'total' => sanitizeStringValue($cells[7], 100),
        ];
    }
